...
: mensaje_corriente
\    SL     :     E     T     N     E     I     R     R     O     C     SL
  h# 10 h# 3A h# 45 h# 54 h# 4E h# 45 h# 49 h# 52 h# 52 h# 4F h# 43  h# 10 d# 12
  d# 0 
  do  
    emit-uart
  loop
...
: mensaje_tiempo
\    SL     :     O     P     M     E     I     T    SL
  h# 10 h# 3A h# 4F h# 50 h# 4D h# 45 h# 49 h# 54 h# 10  d# 9
  d# 0 
  do  
    emit-uart
  loop
...
: mensaje_porcentaje
\    SL     :     E     J     A     T     N     E     C     R     O     P    SL
  h# 10 h# 3A h# 45 h# 4A h# 41 h# 54 h# 4E h# 45 h# 43 h# 52 h# 4F h# 50 h# 10  d# 13 
  d# 0 
  do  
    emit-uart
  loop
...
: mensaje_finalizacion_bateria
\    SL     A     J     A     B   esp     A     I     R      E     T     A     B    SL
  h# 10 h# 41 h# 4A h# 41 h# 42 h# 20 h# 41 h# 49 h# 52  h# 45 h# 54 h# 41 h# 42 h# 10 d# 14   
  d# 0 
  do  
    emit-uart
  loop
...
: con-constant
    h# 008E DtMSB !  \ NUEVO  008E
    h# D280 DtLSB !  \ NUEVO  D280
;   

: restador           \ NUEVO
	swap rot 2dup  < IF h# ffff swap - + d# 1 + swap d# 1 - ELSE - swap THEN
	DtMSB ! DtLSB !
;    
...
\ INICIO BLOQUE IF
\ ========================================================================================
  \ Si DtLSB < 200 y DtMSB = 0
  DtLSB @ d# 200 <
  DtMSB @ d# 0 =  
  = IF
\ ========================================================================================
\ BLOQUE DE EJECUCION CONDICION VERDADERA
\ ========================================================================================
  mensaje_finalizacion_bateria
\ ========================================================================================
\ FIN BLOQUE DE EJECUCION CONDICION VERDADERA
\ ========================================================================================
  ELSE
\ ========================================================================================
\ BLOQUE DE EJECUCION CONDICION FALSA
\ ========================================================================================
...
\ =========================================
  ...
  mensaje_bin2bcd
\ ========================================================================================
\ FIN BLOQUE DE EJECUCION CONDICION FALSA
\ ========================================================================================
  THEN
